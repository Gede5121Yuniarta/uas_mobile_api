                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="kost_type" id="campuran" value="campuran" {{ old('kost_type', $kost->kost_type) == 'campuran'? 'checked' : '' }}>
                            <label class="form-check-label" for="campuran">Campuran</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="kost_type" id="laki-laki" value="laki-laki" {{ old('kost_type', $kost->kost_type) == 'laki-laki'? 'checked' : '' }}>
                            <label class="form-check-label" for="laki-laki">Laki-laki</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="kost_type" id="perempuan" value="perempuan" {{ old('kost_type', $kost->kost_type) == 'perempuan'? 'checked' : '' }}>
