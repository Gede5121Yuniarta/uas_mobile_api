            ...
            @foreach ($rooms as $room)
                <article class="property__card">
                    <div class="property__images">
                        @php
                            $roomMediaFiles = is_array($room->rooms_media)
                                ? $room->rooms_media
                                : explode(',', $room->rooms_media);
                        @endphp

                        @if (!empty($roomMediaFiles) && $roomMediaFiles[0] != '')
                            <img src="{{ asset($roomMediaFiles[0]) }}" alt="{{ $room->rooms_name }}"
                                class="property__img" />
                        @else
                    ...
                    <div class="property__data">
                        ...
                        <span class="property__description">{{ $room->description }}</span>
