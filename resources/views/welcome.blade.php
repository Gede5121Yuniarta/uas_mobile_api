                                ...
                                @if (Route::has('register'))
                                    <div class="relative">
                                        ...
                                        <div id="register-dropdown"
                                            class="absolute hidden bg-white shadow-lg rounded-md mt-2">
...
<script>
    ...
    document.addEventListener('click', function(event) {
        var isClickInside = document.getElementById('register-link').contains(event.target) ||
            document.getElementById('register-dropdown').contains(event.target);
        if (!isClickInside) {
            document.getElementById('register-dropdown').classList.add('hidden');
        }
    });
</script>
