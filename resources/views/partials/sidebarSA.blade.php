<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a 
    {{-- target="_blank"  --}}
    href="{{ route('homepage') }}" class="brand-link text-center">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="info">
                <a href="{{ route('superAdmin.dashboard') }}" class="d-block">{{ Auth::user()->name }} || SA Dashboard</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item" style="margin-bottom: 10px;">
                    <a href="{{ route('superAdmin.indexKost') }}" class="nav-link" style="display: flex; align-items: center;">
