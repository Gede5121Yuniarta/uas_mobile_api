                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ Storage::url($gallery->photo) }}">
                                                    <img src="{{ Storage::url($gallery->photo) }}" width="200"
                                                        alt="">
                                                </a>
                                            </td>
                        ...
                        <form method="post" action="{{ route('admin.properties.update', $property->id) }}">
                            ...
                            <div class="card-body">
                                    ...
                                    <select class="form-control" name="category_id" id="category_id">
                                        @foreach ($categories as $category)
                                            <option {{ $category->id === $property->category->id ? 'selected' : null }}
                                                value="{{ $category->id }}" {{ old('category_id') ? 'selected' : null }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="dimension" class="form-control"
                                        value="{{ old('dimension', $property->dimension) }}">
                                </div>
                                <div class="form-group">
                                    <label for="year_build">Year build</label>
                                    <input type="date" name="year_build" class="form-control"
                                        value="{{ old('year_build', $property->year_build) }}">
                                </div>
                                <div class="form-group">
